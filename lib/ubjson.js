...
var packStreamInternalBuffer = new Buffer(1024);

function packToStreamSync(value, stream) {
  ...
  var off = ubjsonStrtokPack(
    stream /* stream */,
    packStreamInternalBuffer /* buf */, 0 /* buf offset */, value /* value */,
    flush  /* flush */
  );

  flush(packStreamInternalBuffer, off);
}

// Export public functions
exports.unpackBuffer = unpackBuffer;

exports.packToBufferWithOffsetSync = packToBufferWithOffsetSync;
exports.packToBufferSync = packToBufferSync;
exports.packToBuffer = packToBuffer;
exports.packToStreamSync = packToStreamSync;
