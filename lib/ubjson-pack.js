...
/** internal
 * ubjsonPack(s, b, bo, v, flush) -> Integer
 * - s (Stream|null): Stream to write packed UBJSON (optional)
 * - b (Buffer): Buffer to write packed UBJSON
 * - bo (Number): Buffer offset to write
 * - v (mixed): JavaScript value to pack
 * - flush (Function): Flush function, used to dump packed data to stream
 *
